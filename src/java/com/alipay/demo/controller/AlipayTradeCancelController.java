...
@Controller
public class AlipayTradeCancelController {
	
    @RequestMapping(value="/alipayTradeCancel.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeCancel";
        
    }

    @RequestMapping(value="/alipayTradeCancel.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeCancelModel alipayModel){
        Result<AlipayTradeCancelResponse> result = new Result<AlipayTradeCancelResponse>();
