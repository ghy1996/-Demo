...
@Controller
public class AlipayTradeCreateController {
	
    @RequestMapping(value="/alipayTradeCreate.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeCreate";
        
    }

    @RequestMapping(value="/alipayTradeCreate.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeCreateModel alipayModel){
        Result<AlipayTradeCreateResponse> result = new Result<AlipayTradeCreateResponse>();
