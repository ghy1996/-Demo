...
@Controller
public class AlipayTradeOrderSettleController {
	
    @RequestMapping(value="/alipayTradeOrderSettle.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradeOrderSettle";
        
    }

    @RequestMapping(value="/alipayTradeOrderSettle.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradeOrderSettleModel alipayModel){
        Result<AlipayTradeOrderSettleResponse> result = new Result<AlipayTradeOrderSettleResponse>();
