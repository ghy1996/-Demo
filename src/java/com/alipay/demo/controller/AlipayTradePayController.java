...
public class AlipayTradePayController {
    ...
    @RequestMapping(value="/alipayTradePay.htm")
    public String toHtml(HttpServletRequest request,ModelMap modelMap){
        
        return "api/alipayTradePay";
        
    }

    @RequestMapping(value="/alipayTradePay.json", method = RequestMethod.POST)
    @ResponseBody
    public Object doPost(HttpServletRequest request,HttpServletResponse response,ModelMap modelMap,AlipayTradePayModel alipayModel){
